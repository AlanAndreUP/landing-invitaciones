...
export function InvitationClient() {
  ...
  const name = readParam(searchParams.get('name'), 'Invitado especial');
  const email = readParam(searchParams.get('email'), 'No proporcionado');
  const phone = readParam(searchParams.get('phone'), 'No proporcionado');
  const attending = readParam(searchParams.get('attending'), 'si').toLowerCase();
  const message = readParam(searchParams.get('message'), 'Sin mensaje adicional');
